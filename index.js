...
world.addClaster(new Pair(w/2-(w/4)-w/50,w/2-(w/4)+w/50), new Pair(h/2-(h/5)-h/50,h/2-(h/5)+h/50),150, new Speed(50,0*Math.PI),10, 2, false, true);
let clickGUI = new ClickHandler(w,h,canvasCont);
clickGUI.connectToWorld(world);
clickGUI.setMousePosHandler();
clickGUI.setPauseKeyBind();
iter = 0;
